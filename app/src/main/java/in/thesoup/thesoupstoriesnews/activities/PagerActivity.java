...
import in.thesoup.thesoupstoriesnews.preferencesfbauth.UTILS;
...
// add FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS flag to the window
        ...
        if(pref.getString(SoupContract.AUTH_TOKEN,null)!=null&&!pref.getString(SoupContract.AUTH_TOKEN,null).isEmpty()){
          ...
          mNextBtn.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                  ...
                  pparams.put("label", "onboarding_screen");
                  pparams.put("category","tap");
                  pparams.put("position_scn_onboarding",String.valueOf(page));//(only if possible)
                  cleverTap.event.push("tap_next",pparams);
                  ...
                  oparams.put("label", "onboarding_screen");
                  oparams.put("category","screen_view");
                  oparams.put("position_scn_onboarding",String.valueOf(page-1));//(only if possible)
                  cleverTap.event.push("viewed_screen_onboarding",oparams);
          ...
          mBackBtn.setOnClickListener(new View.OnClickListener() {
              ...
              public void onClick(View v) {
                  ...
                  if(page>0){
                      ...
                      nparams.put("label", "onboarding_screen");
                      nparams.put("category","tap");
                      nparams.put("position_scn_onboarding",String.valueOf(page+1));//(only if possible)
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position) {
                case 0:
                    return PlaceholderFragment.newInstance(getString(R.string.onboarding_heading1),getString(R.string.onboarding_heading11),getString(R.string.onboarding_content1),getString(R.string.onboarding_content11),"0", R.drawable.globe_onboarding);
                case 1:
    ...
    public void onBackPressed() {
        ...
        HashMap<String,Object> nparams = new HashMap<>();
        nparams.put("screen_name", "onboarding_screen");
