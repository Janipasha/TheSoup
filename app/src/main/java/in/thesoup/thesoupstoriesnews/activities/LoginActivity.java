...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(pref.getString("auth_token", null))) {
            ...
            nparams.put("label", "login_screen");
            nparams.put("category", "screen_view");
            CleverTap.event.push("viewed_screen_login", nparams);
            ...
            loginButton.registerCallback(callbackmanager,
                    new FacebookCallback<LoginResult>() {
                        ...
                        public void onSuccess(LoginResult loginResult) {
                            ...
                            nparams.put("type_login", "facebook");//(only if possible)
                            CleverTap.event.push("login", nparams);
                                        ...
                                        public void onCompleted(JSONObject jsonobject, GraphResponse response) {
                                            ...
                                            if (response != null && response.getJSONObject() != null) {
                                                ...
                                                if(cleverTap!=null){
                                                    ...
                                                    profileUpdate.put("Identity",prefUtil.getId());
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            nparams.put("label", "login_screen");
            nparams.put("category", "conversion");
            nparams.put("type_login", "google");//(only if possible)
            CleverTap.event.push("login",nparams);
            ...
            if (result != null) {
                ...
                Log.d("google auth",acct.getIdToken());
                ...
                HashMap<String, Object> profileUpdate = new HashMap<>();
                profileUpdate.put("Name",prefUtil.getFirstname()+" "+ prefUtil.getLastname());
                profileUpdate.put("Identity", acct.getId());
                profileUpdate.put("Email",  prefUtil.getEmail());
                profileUpdate.put("Gender",prefUtil.getGender());
                profileUpdate.put("Photo", prefUtil.getPictureUrl());
    ...
    public void onClickSocial(View v) {
        if (v == fb) {
            ...
            nparams.put("type_login", "facebook");//(only if possible)
            CleverTap.event.push("tap_login", nparams);
    ...
    public void onBackPressed() {
        ...
        HashMap<String,Object> nparams = new HashMap<>();
        nparams.put("screen_name", "login_screen");
