...
public class HomeFeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            if (view == bottomtextnumarticles || view == bottomtextshowmore || view == heroimage || view == seenImage || view == readstatus) {
                ...
                if (mposition < StoryDataList.size()) {
                    ...
                    if (view == heroimage) {
                        ...
                        aparams.put("name_section", "from_your_followed");
                        aparams.put("story_title", StoryTitle);
                        aparams.put("story_id", StoryID);
                    ...
                    if (view == heroimage) {
                        ...
                        aparams.put("category", "tap"); //(only if possible)
                        aparams.put("position_card_collection", String.valueOf(mposition));
                        aparams.put("name_section", "stories_for_you");
                        aparams.put("story_title", StoryTitle);
                        aparams.put("story_id", StoryID);
                        aparams.put("substory_name",substoryname);
                        aparams.put("substory_id",substoryId);
            ...
            if (view == viewfullstory || view == storyTitle || view == topstorylayout || view == secondtopstorylayout || view == thirdtopstorylayout) {
                if (mposition < StoryDataList.size()) {
                    ...
                    if (view == viewfullstory||view == storyTitle||view ==topstorylayout) {
                        ...
                        aparams.put("substory_name",substoryname);
                        aparams.put("substory_id",substoryId);
                        cleverTap.event.push("tap_viewstory", aparams);
                    ...
                    if (view == secondtopstorylayout) {
                        ...
                        aparams.put("position_card_collection", String.valueOf(mposition));
                        aparams.put("name_section", "from_your_followed");
                        aparams.put("position_card_old", String.valueOf(1));
                        aparams.put("story_title", StoryTitle);
                        aparams.put("story_id", StoryID);
                        cleverTap.event.push("tap_card_old", aparams);
                    ...
                    if (view == thirdtopstorylayout) {
                        ...
                        aparams.put("position_card_collection", String.valueOf(mposition));
                        aparams.put("name_section", "from_your_followed");
                        aparams.put("position_card_old", String.valueOf(2));
                        aparams.put("story_title", StoryTitle);
                        aparams.put("story_id", StoryID);
                        cleverTap.event.push("tap_card_old", aparams);
    ...
    public void shareclick(StoryDataMain mStoryData) {
        int n = mStoryData.getSubstories().size();
    ...
    public void followstory(StoryDataMain mStoryData) {
        ...
        if(mStoryData.getFollowstatus()!=null&&!mStoryData.getFollowstatus().isEmpty()){
            mfollowstatus = mStoryData.getFollowstatus();
        }
        pref = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        aparams.put("collection_id", clickStoryId);
        aparams.put("collection_name", clickStoryName);
        aparams.put("position_card_collection", String.valueOf(clickposition));
        ...
        if (mfollowstatus.equals("") || mfollowstatus.equals("0") || TextUtils.isEmpty(mfollowstatus)) {
            ...
            cleverTap.event.push("tap_add",aparams);
            HashMap<String, String> params = new HashMap<>();
            ...
            cleverTap.event.push("tap_remove",aparams);
            HashMap<String, String> params = new HashMap<>();
            params.put(SoupContract.AUTH_TOKEN, pref.getString(SoupContract.AUTH_TOKEN, null));
            params.put("story_id", clickStoryId);
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if (view == managehome) {
                ...
                cleverTap.event.push("tap_managehome", aparams);
            ...
            if (view == followedseeall) {
                ...
                aparams.put("category", "tap"); //(only if possible)
                aparams.put("name_section", "from_your_followed");
                cleverTap.event.push("tap_seeall", aparams);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof StoryDataViewHolder) {
            ...
            ((HeaderViewHolder) holder).followedtext.setText("Today in Followed");
